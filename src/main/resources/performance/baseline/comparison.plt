# Nhat : gnuplot baseline_comparison.plot
...
do for [filename in "dist_error dist_error_penalize"] {
  ...
  plot filename . '.csv' using 1:2 title column with linespoints lt 2 pointsize 1 pointtype 6 lw 3, \
    '' u 1:3 title column with linespoints lt 1 pointsize 1 pointtype 1 lw 3, \
    '' u 1:4 title column with linespoints lt 3 pointsize 1 pointtype 2 lw 3, \
    '' u 1:5 title column with linespoints lt 4 pointsize 1 pointtype 3 lw 3, \
    '' u 1:6 title column with linespoints lt 5 pointsize 1 pointtype 4 lw 3, \
    '' u 1:7 title column with linespoints lt 6 pointsize 1 pointtype 8 lw 3
}
